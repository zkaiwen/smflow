...
mainRef.o: mainRef.cpp graph.o aig.o cutenumeration.o cutfunction.o sequential.hpp aggregation.hpp
	g++ $(CFLAGS) -c mainRef.cpp $(PROF) 

mainDB.o: mainDB.cpp graph.o aig.o cutenumeration.o cutfunction.o sequential.hpp aggregation.hpp
